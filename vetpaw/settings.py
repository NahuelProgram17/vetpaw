"""
Django settings for vetpaw project.
...
SECRET_KEY = 'django-insecure-(8#7xy+cr#1wxoy1p7)q7ys8l=s3!u!_-j2!mf2(&yg&wnynf$'
...
# Media files (fotos de mascotas, avatars)
import os
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Auth user model personalizado
